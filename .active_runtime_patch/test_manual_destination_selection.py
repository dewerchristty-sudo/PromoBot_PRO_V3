...
class ManualDestinationSelectionTest(unittest.TestCase):
    ...
    def test_seleciona_revisao_promobot(self):
        ...
        self.assertEqual(
            house["fg_color"],
            page.DESTINATION_DEFAULT_COLOR,
        )
    ...
    def test_envia_somente_para_destino_escolhido(self):
        page = self.page()
        page.database = Mock()
        page.notifier = Mock()
        ...
        sent_args = page.notifier.send_whatsapp_message.call_args.args
        self.assertNotIn("review@g.us", sent_args)
